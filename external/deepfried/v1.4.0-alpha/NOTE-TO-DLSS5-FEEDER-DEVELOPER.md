...
Deep Fried Chicken 1.4.0 now implements the Feeder compatibility surface you
...
Chicken 1.4.0 is source-contract compatible with Feeder v0.7.0 and the current
...
Generation is forwarded, not adopted, and is not claimed as compatible in this
release after a current live test produced a black screen.
